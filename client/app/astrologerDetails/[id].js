...
import { useRouter, usePathname ,useSearchParams,useRoute,useGlobalSearchParams} from 'expo-router';
const astrologerDetails = () => {
    const params = useGlobalSearchParams();
    const router = useRouter() // Correct hook to get query parameters
  ...
  const [astrologer, setAstrologer] = useState(null);
    ...
    useEffect(() => {
        const fetchAstrologerDetails = async () => {
          ...
          const response = await fetch(`http://192.168.1.5:3000/astrologer/getAstro/${params.id}`);
        ...
        <Ionicons name="share-social" size={24} color="black" />
                ...
                <View style={styles.firstContainer}>
                    <View style={styles.profileContainer}>
                        <View>
                            <Image source={{ uri: 'https://img.freepik.com/free-vector/isolated-young-handsome-man-different-poses-white-background-illustration_632498-859.jpg?size=338&ext=jpg&ga=GA1.1.2008272138.1721779200&semt=ais_user' }} style={styles.avatar} />
                    ...
                    <View style={styles.contactContainer}>
                        <View style={styles.contactItem}>
                            ...
                            <Text style={styles.contactText}>76K mins</Text>
                        </View>
                        <View style={styles.contactItem}>
                            <Ionicons name="call" size={24} color="black" />
                            <Text style={styles.contactText}>5K mins</Text>
                        </View>
                    </View>
                </View>
